  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        <h2 className="text-2xl font-bold mt-6 lg:pl-8">{product.pro_title}</h2>
        <p className="text-gray-400 text-xs space-x-1 pb-4 lg:text-[0.9rem] lg:pl-8">
      ...
      <div className="border-t pt-6 lg:grid grid-cols-2 lg:space-y-1">
        <div className="flex lg:pl-8">
      ...
      <div className="flex lg:pl-8 border-t pt-6">
      ...
      <div className="flex border-t py-6 lg:pl-8">
